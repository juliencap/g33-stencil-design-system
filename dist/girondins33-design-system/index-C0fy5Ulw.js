...
const BUILD = /* girondins33-design-system */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, asyncQueue: false, attachStyles: true, cloneNodeFix: false, constructableCSS: false, cssAnnotations: true, deserializer: false, devTools: true, element: false, event: false, experimentalScopedSlotChanges: false, experimentalSlotFixes: false, formAssociated: false, hasRenderFn: true, hostListener: false, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: true, hydrateClientSide: false, hydrateServerSide: false, hydratedAttribute: false, hydratedClass: true, hydratedSelectorName: "hydrated", initializeNextTick: false, invisiblePrehydration: true, isDebug: false, isDev: true, isTesting: false, lazyLoad: true, lifecycle: true, lifecycleDOMEvents: false, member: true, method: false, mode: false, observeAttribute: true, profile: true, prop: true, propBoolean: true, propChangeCallback: false, propMutable: false, propNumber: false, propString: true, reflect: false, scoped: false, scopedSlotTextContentFix: false, scriptDataOpts: false, serializer: false, shadowDelegatesFocus: false, shadowDom: true, shadowSlotAssignmentManual: false, slot: true, slotChildNodesFix: false, slotRelocation: false, state: true, style: true, svg: false, taskQueue: true, transformTagName: false, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: false, vdomKey: true, vdomListener: false, vdomPropOrAttr: true, vdomRef: false, vdomRender: true, vdomStyle: false, vdomText: true, vdomXlink: false };
const Env = /* girondins33-design-system */ {"STORYBLOK_TOKEN":"MiVtrDIHoqpQ5Lt2Qm79mgtt"};

const globalScripts = () => {};
const globalStyles = ":host,\n:root {\n  /* ==========================================\n     COLORS\n  ========================================== */\n\n  --g33-color-primary: #123c7c;\n  --g33-color-primary-hover: #0f3368;\n\n  --g33-color-secondary: #bd0000;\n\n  --g33-color-text: #444444;\n  --g33-color-text-light: #777777;\n\n  --g33-color-white: #ffffff;\n  --g33-color-border: #e5e5e5;\n\n  --g33-color-success: #2e7d32;\n  --g33-color-warning: #ed6c02;\n  --g33-color-error: #d32f2f;\n  --g33-color-info: #0288d1;\n\n  /* ==========================================\n     TYPOGRAPHY\n  ========================================== */\n\n  --g33-font-family: 'Open Sans', sans-serif;\n\n  --g33-font-size-xs: 0.75rem; /* 12px */\n  --g33-font-size-sm: 0.875rem; /* 14px */\n  --g33-font-size-md: 1rem; /* 16px */\n  --g33-font-size-lg: 1.5rem; /* 24px */\n  --g33-font-size-xl: 2rem; /* 32px */\n\n  --g33-font-weight-regular: 400;\n  --g33-font-weight-semibold: 600;\n  --g33-font-weight-bold: 700;\n  --g33-font-weight-black: 900;\n\n  --g33-line-height-default: 1.6;\n\n  /* ==========================================\n     SPACING\n  ========================================== */\n\n  --g33-spacing-xs: 0.25rem; /* 4px */\n  --g33-spacing-sm: 0.5rem; /* 8px */\n  --g33-spacing-md: 1rem; /* 16px */\n  --g33-spacing-lg: 1.5rem; /* 24px */\n  --g33-spacing-xl: 2rem; /* 32px */\n\n  /* ==========================================\n     BORDERS & RADIUS\n  ========================================== */\n\n  --g33-border-width: 1px;\n\n  --g33-radius-sm: 0.25rem; /* 4px */\n  --g33-radius-md: 0.5rem; /* 8px */\n  --g33-radius-lg: 0.75rem; /* 12px */\n\n  /* ==========================================\n     SHADOWS\n  ========================================== */\n\n  --g33-shadow-sm: 0 2px 4px rgba(0, 0, 0, 0.08);\n  --g33-shadow-md: 0 4px 8px rgba(0, 0, 0, 0.12);\n}\n\n";
...
export { BUILD as B, Env as E, H, NAMESPACE as N, bootstrapLazy as b, consoleDevInfo as c, globalScripts as g, h, promiseResolve as p, registerInstance as r, setNonce as s, win as w };
//# sourceMappingURL=index-C0fy5Ulw.js.map
