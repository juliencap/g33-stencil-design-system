...
const G33Button = class {
    ...
    disabled = false;
    render() {
        return (h("button", { key: '2dd141fa9d588c03ffd39239899e364ef9abfbcc', class: `button button--${this.variant} button--${this.size}`, disabled: this.disabled }, h("slot", { key: '6a465df0708dca7beee07a1e5700eeb214813676' })));
    }
};
