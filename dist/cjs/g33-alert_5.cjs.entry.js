...
const g33ShowcaseCss = () => `:host{display:block;font-family:Arial, sans-serif}main{padding:32px}section{margin-top:32px}.demo-row{display:flex;gap:12px;margin-bottom:12px}g33-button{margin-right:12px}`;
